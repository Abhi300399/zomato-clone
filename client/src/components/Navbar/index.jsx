...
const LargeNav=()=>{
    return <>
    <div className="hidden gap-4 md:flex w-full items-center justify-between ">
             <div className="w-28">
                    <img src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png" alt="logo" className="w-full h-full" />
             </div>
             <div className="w-full bg-white shadow-md p-3 border border-gray-200 rounded flex items-center gap-3">
                 <div className="flex items-center gap-2 border-r-2 border-gray-300 pr-2">
                    <span className="text-zomato-400"><HiLocationMarker/></span>
                    <input type="text" placeholder="Benguluru"/>
                    <IoMdArrowDropdown/>
                 </div>
...
const Navbar=()=>{
    return (<>
        <nav className="p-4 flex items-center bg-white shadow-md w-full">
                 <MobileNav />
                 <MediumNav />
        </nav>
    </>
